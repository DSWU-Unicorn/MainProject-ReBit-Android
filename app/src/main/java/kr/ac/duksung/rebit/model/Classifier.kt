package kr.ac.duksung.rebit.model
...
class Classifier(private var context: Context, private val modelName: String) {
    ...
    companion object {
//        const val IMAGENET_CLASSIFY_MODEL = "CNN.tflite"
        const val IMAGENET_CLASSIFY_MODEL = "vanilaCNN_lv2_plastic.tflite"
//        const val LABEL_FILE = "labels.txt"
        const val LABEL_FILE = "labels_lv2.txt"
    }
}